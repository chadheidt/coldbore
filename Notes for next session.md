...
- **Gate-2: 30/61 dual-corroborated** (Hornady 12, Sierra 5, Berger 5, Lapua 4, Nosler 3, Barnes 1; CE/Lehigh 0). **Tolerance policy locked (Chad): independent-source ΔG7≤0.010** (≤0.006 only for same-copied-number), applied uniformly + Δ recorded per-bullet. **Sierra BREAKTHROUGH**: sierrabullets.com product pages embed structured JSON with Sierra's OWN single G7 (machine-readable via escaped-quote regex) → the popular SMK line (142/168/175/220/107) dual-sourced vs Litz, was #1 fill target. Lapua 167 retroactively corroborated. 31 remaining blanks (Sierra TMK/GameKing, Berger singles, Nosler RDF, Barnes LRX/MatchBurner, CE/Lehigh, Hornady A-Tip re-confirm) — DB grows data-only post-launch, never blocks ship. 191 tests green. Full detail: `Ballistic Solver — Gate 2 BC Curation Log.md`.
