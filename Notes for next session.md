...
1. **Workbook UI change** — Phase 1 (Rifle & Setup) v0.14.7 + Phase 2 (Range Session & DOPE) v0.14.8 SHIPPED, both Chad-reviewed + bundle-verified. UNIFIED SHELL: built + panelized forms + self-verified in isolation during Chad offline-hour (nav=left sidebar, 2 self-caught bugs fixed, 149/149, NOT wired/shipped). Previews /tmp/shell_setup2.png + /tmp/shell_dope2.png opened for review. AWAITING Chad: approve look -> wire into MainWindow -> ship. [[loadscope-shell-scoping]]
