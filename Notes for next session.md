...
1. **Workbook UI change** — Phase 1 SHIPPED v0.14.7 (native Rifle & Setup form, Workbook menu, Chad-reviewed + bundle-verified). NEXT = Phase 2 (session + DOPE entry; solver plugs in). [[loadscope-appify-scoping]]
