...
# "Cold Bore". Safe to run multiple times — every step checks first whether
...
NEW_CONFIG_DIR="$HOME/Library/Application Support/Cold Bore"
...
echo "============================================================"
echo "Cold Bore — cleanup of old Rifle Load Importer artifacts"
echo "============================================================"
echo ""
echo "This will:"
echo "  1. Copy your old config to the new Cold Bore location (if needed)"
...
echo ""
echo "Next steps:"
echo "  1. Double-click 'Build App.command' to build the new Cold Bore.app"
echo "  2. Drag the new Cold Bore.app from dist/ to Applications"
