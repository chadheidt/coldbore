...
echo "============================================================"
echo "Loadscope — manifest URL diagnostic"
echo "============================================================"
echo ""
echo "Fetching: $URL"
echo ""
...
try:
    req = urllib.request.Request(url, headers={"User-Agent": "Loadscope/0.6.0"})
...
print("Make sure you dragged dist/Loadscope.app to Applications,")
